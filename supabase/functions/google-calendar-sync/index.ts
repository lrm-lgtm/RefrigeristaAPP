...
Deno.serve(async(req)=>{
  ...
  try{
    ...
    workOrderId=String(body?.work_order_id||"");
    if(!workOrderId)return json({error:"work_order_id_required"},400);
    ...
    const result:any={appointment:"unchanged",preventive:"unchanged"};
